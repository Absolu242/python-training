...
if answer == 'left':
    ...
    if answer == 'swim':
        ...
        print('You walked fo many miles , ran out of eater and you lost the game')
    else:
        print("Not a valid option. You lose.")
elif answer == 'right':
    answer = input(
        'You come to a bridge, it loks wobbly , do you want to cross it or head back (cross/back) ? ')
